...
app.authorize.interceptors.identity({
    ...
    onLoad: function (option) {
        ...
        var longitude =  wx.getStorageSync('longitude') ?  wx.getStorageSync('longitude') : option.longitude;
        var latitude =   wx.getStorageSync('latitude') ?  wx.getStorageSync('latitude') : option.latitude;
        //var buy_seller_id =   wx.getStorageSync('buy_seller_id') ?  wx.getStorageSync('buy_seller_id') : option.buy_seller_id;
        wx.request({
    ...
    go_detail: function (e) {
        ...
        var buy_seller_id =   wx.getStorageSync('buy_seller_id') ?  wx.getStorageSync('buy_seller_id') : option.buy_seller_id;
        wx.navigateTo({
            url: '../coupon_detail/index?&id=' + id + '&isShowSeller=0' + "&buy_seller_id=" + buy_seller_id,
        })
    },
    go_map: function () {
